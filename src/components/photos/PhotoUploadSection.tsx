    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col-reverse items-end gap-3">
        ...
        <Button
          onClick={toggleMenu}
          size="icon"
          className={`h-14 w-14 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 ${isMenuOpen ? 'rotate-45' : ''} animate-breathing`}
        >
