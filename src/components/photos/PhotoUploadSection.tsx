            ...
            {isMobile && (
              <>
                ...
                <Button
                  ...
                  variant="secondary"
                  size="sm"
                  className="w-full bg-gradient-to-r from-pink-500/90 to-rose-500/90 hover:from-pink-600 hover:to-rose-600 text-white border-none shadow-md hover:shadow-lg transition-all duration-300"
                >
