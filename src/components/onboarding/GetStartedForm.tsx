...
export const GetStartedForm = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <main className="flex-1 container max-w-md mx-auto px-2 py-2 md:px-4 md:py-4 flex flex-col h-[calc(100vh-64px)]">
        <div className="bg-white rounded-lg shadow-sm p-3 md:p-8 mb-2 md:mb-16 flex-1 flex flex-col">
          <h1 className="text-2xl md:text-4xl font-light text-center text-wedding-pink mb-4 md:mb-12">
            Create new wedding
          </h1>
